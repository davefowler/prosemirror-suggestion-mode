...
import { suggestionModePlugin, acceptAllSuggestions, rejectAllSuggestions, addSuggestionMarks, applySuggestion, } from 'prosemirror-suggestion-mode';
...
const createSuggestionReasonComponent = (attrs) => {
    var _a;
    const reasonDiv = document.createElement('div');
    reasonDiv.className = 'suggestion-reason';
    const reason = (_a = attrs === null || attrs === void 0 ? void 0 : attrs.data) === null || _a === void 0 ? void 0 : _a.reason;
    if (reason) {
...
window.addEventListener('load', () => {
  ...
  `;
    ...
    (_a = document
        .querySelector('#acceptAllSuggestions')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', () => {
        acceptAllSuggestions(view.state, view.dispatch);
    });
    (_b = document
        .querySelector('#rejectAllSuggestions')) === null || _b === void 0 ? void 0 : _b.addEventListener('click', () => {
